    ...
    return `
      ...
      <div class="topic-card">
        ...
        <div class="step-card">
          ...
          <img src="/images/scenario_fire.png" alt="Fire in kitchen" style="width: 65%; height: auto; display: block; margin: 16px auto; border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);" />
        ...
        <div class="step-card">
          ...
          <img src="/images/scenario_sick.png" alt="Sick child" style="width: 65%; height: auto; display: block; margin: 16px auto; border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);" />
      ...
      <div class="topic-card">
        <div class="step-card">
          ...
          <img src="/images/scenario_bicycle.png" alt="Stolen Bicycle" style="width: 65%; height: auto; display: block; margin: 16px auto; border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);" />
        ...
        <div class="step-card">
          ...
          <img src="/images/scenario_lost.png" alt="Lost in Market" style="width: 65%; height: auto; display: block; margin: 16px auto; border-radius: 12px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);" />
